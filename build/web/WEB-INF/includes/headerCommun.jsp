...
<header>
    <div class="container">
        ...
        <nav>
            <ul>
                <li class="current"><c:url var="acceuil" value="FrontControleur?section=home" /><a href="${acceuil}">Accueil</a></li>
                ...
                <li><c:url var="panier" value="FrontControleur?section=afficher-panier" /><a href="${panier}">Panier</a></li>
            </ul>
        </nav>
    </div>
</header>
