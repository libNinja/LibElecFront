...
import modelhe.VerificateurSaisie;
import modelhe.GestionClient;
...
@WebServlet(name = "FrontControl", urlPatterns = {"/FrontControleurEspaceClient"})
public class FrontControleurEspaceClient extends HttpServlet {
