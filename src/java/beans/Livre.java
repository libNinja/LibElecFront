...
public class Livre implements Serializable{
    ...
    public Livre(String isbn, long ediId, long tvaId, long proId, String ouvNom, int livEdition, Date livDateEdition, String livResume, float livPrix, int livStock, String livImage, String livSousTitre, int livStatut, String livChampLibre, Float proReduction) {
        this.isbn = isbn;
        this.ediId = ediId;
        this.tvaId = tvaId;
        this.proId = proId;
