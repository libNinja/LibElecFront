...
<html>
    ...
    <body>
        ...
        <form action='FrontControleur?section=livraison-enregistre' method='POST' accept-charset="UTF-8">
        ...
        <a href="FrontControleur?section=afficher-nouveauClient"> <input type="submit" name="submit" value="precedent" /></a>
        <a href="FrontControleur?section=afficher-recap"> <input type="submit" name="recap" value="Valider" /></a>
    </body>
</html>