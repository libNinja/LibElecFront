...
<html>
    ...
    <body>
        ...
        <br />   
        <a href="FrontControleur?section=afficher-livraison"> <input type="submit" name="submit" value="precedent" /></a>
        
        <a href="FrontControleur?section=afficher-paiement"> <input type="submit" name="submit" value="confirmer" /></a>
